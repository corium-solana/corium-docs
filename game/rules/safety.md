...
Everything except `feed`, `request_push` and the two claims is **permissionless bookkeeping**. If our crank stops, anyone can run those instructions and the queue keeps draining. See the [program reference](/game/rules/program).
