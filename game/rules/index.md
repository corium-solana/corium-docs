...
There is one playable star at a time. You send **native SOL**. STARDUST is a score kept on your player account. It is not a token. Dead stars stay in the archive, with the planets their feeders seeded; see [the universe](/game/universe).
...
- [Odds & payouts](/game/rules/odds): the nova formula, and why every push returns 96.86%
- [Sending & fees](/game/rules/fees): push sizes, the fee split, and exactly what rent you sign
- [Randomness](/game/rules/randomness): rounds, VRF draws, and why the seed can't be gamed
- [Black hole & next star](/game/rules/black-hole): the feeder payout and how new stars are born
- [Refunds & safety](/game/rules/safety): why nothing can freeze, and what happens if the game dies
- [STARDUST](/game/rules/stardust): how the score is earned
- [Program reference](/game/rules/program): every instruction, and who can call it
