...
|---|---|
| **under 1 SOL** | **Feed.** Settles instantly. Can't cause a nova. Gives you a hole ticket. |
...
If your push triggers the nova, you become the star's **killer** and can claim the entire prize pool, which is 96.86% of everything that went into the star.
...
- **You killed the star:** claim your prize from the app. It is yours to claim once, and there is no deadline.
- **The star collapsed into a black hole:** each feeder claims their share from the app.
- **Your push never rolled** (the star died first, or the round was voided): your stake is refunded in full.

## Then a new star is born

As soon as a star dies, collapses, or has 21 SOL committed, anyone can start the next one. Play moves on straight away, even while the old star's queue finishes settling.
